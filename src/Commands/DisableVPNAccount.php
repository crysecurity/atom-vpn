...
class DisableVPNAccount extends Command
{
     ...
     * @var string
     */
    protected $signature = 'atom-vpn:disable-vpn-account {vpn_usernames : vpn usernames separated by commas. Example partner124,partner34534}';
     ...
     * @var string
     */
    protected $description = 'Disabling VPN accounts';
    ...
    public function handle(AtomVPN $atomVPN): int
    {
        ...
        foreach ($vpnUsernames as $vpnUsername) {
            $atomVPN->disableAccount($vpnUsername);
